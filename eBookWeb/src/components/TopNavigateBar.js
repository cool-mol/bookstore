...
export class TopNavigateBar extends React.Component {
    ...
    componentWillMount() {
        ...
        else if(this.props.page === "chatroom") idx = '5';
        else if(this.props.page === "admin") idx = '6';
    ...
    changeChatroom = () => {
        this.props.changePageTo("chatroom");
    };
    ...
    renderAdmin = () => {
        ...
        return (
            <Menu.Item key="6" onClick={this.changeAdmin}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <Menu theme={"dark"} defaultSelectedKeys={this.state.navIndex} mode="horizontal">
                        ...
                        <Menu.Item key="5" onClick={this.changeChatroom}>
                            <Icon type="user" style={{fontSize: '18px'}}/>
                            <span style={{fontSize: '16px'}}>在线聊天</span>
                        </Menu.Item>
                        {this.renderAdmin()}
                    </Menu>
                </div>
